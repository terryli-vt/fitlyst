      ...
      <div className="flex items-center gap-5 flex-1 min-w-0">
        {user.image ? (
          <Image
            ...
            width={80}
            height={80}
            className="rounded-full ring-4 ring-teal-100 dark:ring-teal-900 shrink-0"
          />
        ) : (
          <div className="w-20 h-20 rounded-full bg-teal-100 dark:bg-teal-900/30 flex items-center justify-center shrink-0">
